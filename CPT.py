...
class player(pygame.sprite.Sprite):
    ...
    def collision(self):
        ...
        if (self.rect.y > screen.get_height() - 80):
            self.speed2 = 0
            self.rect.y = screen.get_height() - 80
        if (self.rect.x >= screen.get_width() - 30):
            self.speed1 = 0
            self.rect.x = screen.get_width() - 30
        elif (self.rect.x <= 5):
            self.speed1 = 0
            self.rect.x = 5
...
#player_image = pygame.image.load("baljeet.png").convert()
#rock_image.set#
